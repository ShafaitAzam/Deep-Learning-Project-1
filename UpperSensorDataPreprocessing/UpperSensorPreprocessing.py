...
for j in range(3749):
    ...
    #plt.colorbar()
    #plt.show()
    plt.imsave(f'C:/ML/RawDataCollectedFromSensors/UpperSensorDataPreprocessing/Spectrograms/spectrogram_{j}.png', normalized_spectrogram, cmap='magma')
    np.save(f'C:/ML/RawDataCollectedFromSensors/UpperSensorDataPreprocessing/NumpySpectrograms/spectrogram_{j}.npy', normalized_spectrogram)
